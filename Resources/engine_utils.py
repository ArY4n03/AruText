...
def exportProject(exportDir,engine):
    ...
    #build game_runner.py in that location in export directory
    subprocess.run([pyinstaller_path,"--onefile","--noconsole","--distpath",exportDir,game_runner_path])
    Scenes_dir = Path(engine.GameDir + '/Scenes')

    #copying scene files export directory
    ...
    #Deleting build directory and spec file
    shutil.rmtree("build",ignore_errors=True)
    os.remove("game_runner.spec")